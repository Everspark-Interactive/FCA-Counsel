...
$paged = (get_query_var('paged')) ? get_query_var('paged') : 1;
 ?>
				<?php $wp_query = new WP_QUERY( array ('post_type' => 'page', 
                    'orderby' => 'date', 
                    'order'   => 'ASC', 
                    'post_status' => 'publish',
                     'posts_per_page' => '1000',
                     'paged' => $paged, 
                     'meta_key'     => 'show_in_faq_page',
    'meta_value'   => 'Yes',
    'meta_compare' => '==' ) );
                $ab=0;
			if ( $wp_query -> have_posts() ) : 
				...
				<div class="fusion-column col-lg-4 col-md-4 col-sm-4 abb<?php echo $ab; ?>">
					...
					<a href="<?php echo get_permalink(); ?>"><div class="faqboxes-inner-bg" style="background-image:url('<?php echo get_field('faq_thumbnail'); ?>')"></div></a>
						...
						<h2><div class="faqbox-date" style="display: none;"><?php echo get_the_date( 'F j, Y' ); ?></div><a href="<?php echo get_permalink(); ?>"><?php the_title(); ?></a></h2>
						</div>
					</div>
